...
gcc -std=c99 %programmname%.c %programmname_2%.c %programmname_3%.c %programmname_4%.c %programmname_5%.c %programmname_6%.c %programmname_7%.c %programmname_8%.c %programmname_9%.c %programmname_10%.c -o %programmname% 
